# Generated by Django 3.0.6 on 2020-08-15 13:27
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('hall', models.ForeignKey(null=True, on_delete=django.db.models.deletion.CASCADE, to='movies.Hall')),
            ],
            options={
                'db_table': 'Seance',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('row', models.IntegerField(default=0)),
                ('seat', models.IntegerField(default=0)),
                ('seance', models.ForeignKey(null=True, on_delete=django.db.models.deletion.CASCADE, to='movies.Seance')),
